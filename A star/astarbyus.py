...
def compute_adaptive_path(grid, start, goal, h_values, tie_break):
    ...
    while not open_list.empty():
        ...
        if current == goal:
            ...
            return reconstruct_path(came_from, start, goal), g_score, came_from, expanded
        ...
        for neighbor in get_neighbors(current, grid_size):
            ...
            if neighbor not in g_score or tentative_g_score < g_score[neighbor]:
                ...
                print(f"✅ Added Neighbor {neighbor}, g_score={g_score[neighbor]}, f_score={f_score[neighbor]}")

    print(f"❌ No path found. Returning empty.")
